                ...
                <div class="card mb-2">
                    ...
                    <div class="card-body">
                        ...
                        <div class="order-btn-wraper">
                            ...
                            @elseif ($order['order_status'] == 'handover' && (in_array($order['order_type'],['dine_in','take_away']) ||
                        ...
                        <div class="card-body">
                            ...
                            <div class="d-flex justify-content-between align-items-center">
                                <h5 class="card-title">
                                    ...
                                    <span>
                                        {{ $order->order_type == 'dine_in' ? translate('Order_Info') : translate('delivery_info') }}
                                    </span>
                                </h5>
                            </div>
                            @if (isset($address))
...
<div class="invoice-sidebar" id="invoiceSidebar">
    <span class="close-sidebar" onclick="closeInvoiceSidebar()">&times;</span>
    <div class="print-btn-container">
        <button class="btn btn-primary print-Div" onclick="printInvoice()">
