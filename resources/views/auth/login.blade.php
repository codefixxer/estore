    ...
    <main id="content" role="main" class="main auth-bg">
        ...
        <div class="d-flex flex-wrap align-items-center justify-content-between">
            <div class="auth-content">
                <div class="content">
                    <h2 class="title text-uppercase">{{ translate('messages.welcome_to') }}
                        {{ $app_name ?? 'STACKFOOD' }}</h2>
                    <p>
                    ...
                    <form class="login_form" action="{{ route('login_post') }}" method="post" id="form-id">
                        ...
                        <div class="js-form-message form-group mb-2">
                            <label class="form-label text-capitalize"
                                for="signinSrEmail">{{ translate('messages.your_email') }}</label>
                            <input type="email" class="form-control form-control-lg" value="{{ $email ?? '' }}"
                                name="email" id="signinSrEmail" tabindex="1" aria-label="email@address.com" required
                            ...
                            <div class="form-group">
                                <div class="custom-control custom-checkbox">
                                    <input type="checkbox" class="custom-control-input" id="termsCheckbox"
                                        {{ $password ? 'checked' : '' }} name="remember">
                            ...
                            <div class="form-group {{ $role == 'admin' ? '' : 'd-none' }}" id="forget-password">
                                <div class="custom-control">
                                    <span type="button" data-toggle="modal"
                                        data-target="#forgetPassModal">{{ translate('Forget_Password?') }}</span>
                                </div>
                            </div>
                            <div class="form-group {{ $role == 'vendor' ? '' : 'd-none' }}" id="forget-password1">
                                <div class="custom-control">
                                    <span type="button" data-toggle="modal"
                                        data-target="#forgetPassModal1">{{ translate('Forget_Password?') }}</span>
                                </div>
                            </div>
                        </div>
                        <!-- End forget password -->
                        ...
                        <button type="submit" class="btn btn-lg btn-block btn-primary"
                            id="signInBtn">{{ translate('messages.sign_in') }}</button>
                    </form>
                    <!-- End Form -->
                ...
                <div class="modal-body">
                    <div class="forget-pass-content">
                        ...
                        <form class="" action="{{ route('vendor-reset-password') }}" method="post">
                            ...
                            <button type="submit"
                                class="btn btn-lg btn-block btn--primary mt-3">{{ translate('messages.Send_Mail') }}</button>
                        </form>
                    </div>
                </div>
            </div>
