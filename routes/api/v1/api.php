...
// Route::group(['namespace' => 'Api\V1'], function () {
    // Route::post('tslots', 'OrderController@get_takeaway_time_slots');
// });
// 
...
Route::group(['namespace' => 'Api\V1', 'middleware'=>['localization','react']], function () {
   ...
   // new api's
            Route::post('tslots', 'OrderController@get_takeaway_time_slots');
            Route::post('dslots', 'OrderController@get_delivery_time_slots');
    ...
    Route::group(['prefix' => 'config'], function () {
        ...
        Route::get('slots-take' , 'ConfigController@slotsTake');
        Route::get('slots-deliver' , 'ConfigController@slotsDeliver');
    });
    ...
    Route::group(['prefix' => 'restaurants'], function () {
        ...
        Route::get('dine-in', 'RestaurantController@get_dine_in_restaurants');
