...
//     $filterDate = $request->filter_date ? Carbon::parse($request->filter_date) : Carbon::today();
...
//         })
//         // Replace the date range filter with single date filter
//         ->when($filterDate, function ($query) use ($filterDate) {
//             return $query->whereDate('created_at', $filterDate);
//         })
//         // In your controller
// // ->when($filterDate, function ($query) use ($filterDate) {
// //     return $query->whereDate('created_at', Carbon::parse($filterDate)->format('Y-m-d'));
// // })
...
//     return view('admin-views.order.list', compact('orders', 'status', 'orderstatus', 'scheduled', 'vendor_ids', 'zone_ids', 'total', 'order_type', 'filterDate'));
// }
