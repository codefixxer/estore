...
class OrderController extends Controller
{
    ...
    public function get_running_orders(Request $request)
    {
        ...
        // by saqib ali (mrsaqibale)
        ->where('created_at', '>=', Carbon::now()->subMinutes(40))  //just fix the logic of this line bcz everything work without this line 
        ->when(isset($request->user)  , function($query){
            $query->where('is_guest' , 0);
        })
    ...
    // code by saqib ali show the slots of time  
