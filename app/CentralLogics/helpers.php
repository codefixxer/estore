...
// mrsaqibale
// this function check is admin is login 
// if admin login then show all options of side bar of permit modules only 
// custom_check_permission
public static function custom_check_permission()
{
    // Only return true for admins (not managers)
    return auth('admin')->check() && auth('admin')->user()->role_id == 1;
}
